...
urlpatterns = [
    ...
    url(r'^accounts/password/change/$',
                    murmur_acct,
                    {'acct_func': auth_views.PasswordChangeView.as_view(template_name='registration/password_change_form.html'), 'template_name': 'registration/password_change_form.html'},
                    name='password_change',
                    ),
    url(r'^accounts/password/change/done/$',
                    murmur_acct,
                    {'acct_func': auth_views.PasswordChangeDoneView.as_view(), 'template_name': 'registration/password_change_done.html'},
